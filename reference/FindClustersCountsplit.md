...
clusters determined via the countsplit algorithm. Latest clustering
results will be stored in the object metadata under
countsplit_clusters'. Note that 'countsplit_clusters' will be
overwritten ever time FindClustersCountsplit is run.
